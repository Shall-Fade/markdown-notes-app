<template>
  <div class="p-[10px]">
    <div class="flex items-center justify-between mb-[5px]">
      ...
      <button class="flex items-center justify-center w-[24px] h-[24px]" type="button">
    ...
    <ul class="flex flex-col gap-y-[5px] ml-[20px]">
      <li class="flex items-center justify-between">
        <div class="flex items-center gap-[5px]">
            <!-- <img src="" alt="Icon"> -->
            <span>Active</span>
        </div>
        <span class="text-[14px] text-light-grey">5</span>
      </li>
    </ul>
  </div>
</template>
